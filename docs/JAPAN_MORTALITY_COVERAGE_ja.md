...
| 2000～2025年 | [日本の超過死亡ダッシュボード](https://exdeaths-japan.org/) | `Observed.csv`、`Observed.csv.zip`内の死因別CSVの`Observed_weighted` | なし | 全死因、悪性新生物、循環器系、呼吸器系、老衰、自殺、COVID-19 | 全国・47都道府県の実週次死亡数、全年齢粗死亡率。年次・インフルエンザ年へ集計可能 |
