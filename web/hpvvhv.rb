...
<head>
<meta charset="UTF-8">
<title id="pageTitleTag">HPVワクチン接種後の体調不良新規受診者数の推移と健康被害認定・子宮頸癌患者・死者との比較</title>
<style>
...
<h1 id="h1Title" align=center>HPVワクチン接種後の体調不良新規受診者数の推移と<br>健康被害認定・子宮頸癌患者・死者との比較</h1>
<a class="site-title-qr" href="https://medicalfacts.info/hpvvhv.rb"><img src="qr/hpvvhv.rb.svg" alt="このページのQRコード" title="このページのQRコード"></a>
</div>

<h2 id="srDesc" class="sr-only">HPVワクチン健康被害認定者、子宮頸癌罹患・死亡者、HPVワクチン接種後の体調不良を主訴として協力医療機関を受診した患者(新規)の累積推移。1つ目のグラフは4系列を同一目盛り(0〜800人)で重ねたもので、体調不良を主訴とする受診患者の累積は2025年11月までに750人に達するのに対し、HPVワクチン健康被害認定者・子宮頸癌罹患者・死亡者の3系列はこのスケールではほぼ横ばいに見える。2つ目のグラフはその3系列を目盛り最大値80に拡大したもので、HPVワクチン健康被害認定者が2026年3月までに約65〜75人まで積み上がる。体調不良を主訴として協力医療機関を受診した患者もこのグラフに含めているが、すぐにこのスケールを超えて見切れる。HPVワクチン健康被害認定者・子宮頸癌の罹患者・死亡者は、接種時または診断・死亡時の年齢が20歳未満か25歳未満かをトグルで切り替えられる。</h2>
...
<span id="ageGroupLabel" style="font-size:15px;color:#52514e">年齢区分</span>
<div style="display:inline-flex;border:0.5px solid #c3c2b7;border-radius:8px;overflow:hidden">
<button id="btn20" type="button" style="padding:6px 16px;font-size:15px;border:none;cursor:pointer;background:#2a78d6;color:#fff">20歳未満</button>
<button id="btn25" type="button" style="padding:6px 16px;font-size:15px;border:none;cursor:pointer;background:transparent;color:#52514e">25歳未満</button>
</div>
</div>

<div id="chartAllHeading" style="font-size:16px;color:#52514e;margin:6px 0 2px">体調不良を主訴として協力医療機関を受診した患者</div>
<div id="chartAllSub" style="font-size:15px;color:#111;margin-bottom:8px">(Y軸80以下の詳細は下のグラフ参照)</div>
<div style="position:relative;width:100%;height:280px">
<canvas id="chartAll" role="img" aria-label="折れ線グラフ。体調不良を主訴として協力医療機関を受診した患者の累積は750人まで増加するのに対し、HPVワクチン健康被害認定者・子宮頸癌罹患者・死亡者の3系列はこのスケールではほぼ横ばいに見える。">全系列データ</canvas>
</div>
<div id="legendAll" style="display:flex;flex-wrap:wrap;gap:18px;margin:10px 0 6px"></div>

<div id="chartZoomHeading" style="font-size:16px;color:#52514e;margin:28px 0 2px;border-top:0.5px solid #e1e0d9;padding-top:20px">HPVワクチン健康被害認定者・子宮頸癌罹患者・死者</div>
<div id="chartZoomSub" style="font-size:15px;color:#111;margin-bottom:8px">(上のグラフのY軸80以下を拡大)</div>
<div style="position:relative;width:100%;height:270px">
<canvas id="chartZoom" role="img" aria-label="折れ線グラフ。最大値を80として拡大。HPVワクチン健康被害認定者は2026年3月までに約65〜75人まで積み上がる。子宮頸癌の罹患者・死亡者はごくわずかにとどまる。体調不良を主訴として協力医療機関を受診した患者はこのスケールをすぐに超え、画面上部で見切れる。">拡大図データ</canvas>
</div>
<div id="legendZoom" style="display:flex;flex-wrap:wrap;gap:18px;margin:10px 0 6px"></div>

<div class="note-list" style="font-size:15px;color:#111;line-height:1.5;margin-top:18px">
<div class="note-item"><span class="mark">※</span><span id="note1Text" class="text">HPVワクチン健康被害認定者は個票データが2019年9月以降、近い間隔(ほぼ毎回の審議結果)で追えるため2019年9月起点とし(それ以前は概数「約340人」)、子宮頸癌患者と死者も比較のため同時期からの累積とした</span></div>
<div class="note-item"><span class="mark">※</span><span id="note2Text" class="text">受診患者は厚労省のサーベイランス調査自体が2022年3月分から開始されており、それ以前のデータが存在しないため2022年3月起点からの累積となっている</span></div>
<div class="note-item"><span class="mark">※</span><span id="note3Text" class="text">受診患者は20歳未満・25歳未満の区別ができないので切替え不可</span></div>
</div>

<div style="font-size:15px;color:#111;margin-top:18px;line-height:1.9;border-top:0.5px solid #e1e0d9;padding-top:14px">
<div id="sourcesHeading" style="font-weight:500;margin-bottom:6px">出典</div>

<div style="margin-bottom:10px">
<span id="src1Text">HPVワクチン健康被害認定者（定期接種）: 厚生労働省「疾病・障害認定審査会 感染症・予防接種審査分科会 審議結果一覧」</span><br>
...
<div style="margin-bottom:10px">
<span id="src3Text">PMDA側 2021年3月末時点317人</span><br>
...
<div style="margin-bottom:10px">
<span id="src4Text">PMDA側 2025年3月末時点321人</span><br>
...
<div style="margin-bottom:10px">
<span id="src5Text">子宮頸癌罹患・死亡データ(がん統計・国立がん研究センター)</span><br>
...
<span id="src6Text">体調不良を主訴として協力医療機関を受診した患者数(HPVワクチンの安全性に関するフォローアップ研究、第110回副反応検討部会資料3-4、2026年2月4日)</span><br>
...
var I18N = {
  ja: {
    ...
    note1: "HPVワクチン健康被害認定者は個票データが2019年9月以降、近い間隔(ほぼ毎回の審議結果)で追えるため2019年9月起点とし(それ以前は概数「約340人」)、子宮頸癌患者と死者も比較のため同時期からの累積とした",
    note2: "受診患者は厚労省のサーベイランス調査自体が2022年3月分から開始されており、それ以前のデータが存在しないため2022年3月起点からの累積となっている",
    ...
    src6: "体調不良を主訴として協力医療機関を受診した患者数(HPVワクチンの安全性に関するフォローアップ研究、第110回副反応検討部会資料3-4、2026年2月4日)",
  ...
  en: {
    ...
    note1: "HPV vaccine injury certification recipients can be tracked at close intervals (nearly every deliberation) from individual case records starting September 2019 (approx. 340 certified before this), so cervical cancer cases and deaths are also cumulated from the same starting point for comparison.",
    note2: "Symptom-visit patient data starts from the MHLW surveillance survey's own start date of March 2022, as no data exists before that.",
    note3: "Symptom-visit patients cannot be distinguished by under-20/under-25 age, so this series does not change with the age toggle.",
    sourcesHeading: "Sources",
    src1: "HPV vaccine injury certification recipients (routine vaccination): MHLW, Review Results of the Infectious Diseases and Immunization Subcommittee",
    src2: "HPV vaccine injury certification recipients (former voluntary vaccination / PMDA): MHLW's HPV Vaccine Adverse Reaction Damage Assessment Committee. The index page is used from April 2024 onward; materials for April 2018–February 2024 were searched individually by meeting name.",
    src3: "PMDA side, as of end of March 2021: 317",
    src4: "PMDA side, as of end of March 2025: 321",
    src5: "Cervical cancer incidence/mortality data (Cancer statistics, National Cancer Center Japan)",
    src6: "Number of patients visiting designated medical institutions with symptoms as primary complaint (Follow-up study on HPV vaccine safety, 110th Adverse Reaction Review Committee, Document 3-4, February 4, 2026)",
...
function setLang(lang){
  ...
  document.getElementById('note1Text').textContent = t.note1;
  document.getElementById('note2Text').textContent = t.note2;
  document.getElementById('note3Text').textContent = t.note3;
  document.getElementById('sourcesHeading').textContent = t.sourcesHeading;
  document.getElementById('src1Text').textContent = t.src1;
  document.getElementById('src2Text').textContent = t.src2;
  document.getElementById('src3Text').textContent = t.src3;
  document.getElementById('src4Text').textContent = t.src4;
  document.getElementById('src5Text').textContent = t.src5;
  document.getElementById('src6Text').textContent = t.src6;
