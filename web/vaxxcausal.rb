...
.record-grid { display:grid;grid-template-columns:minmax(0,2.15fr) minmax(330px,1fr);gap:14px;align-items:start; }
...
.basic-cell { display:flex;flex-wrap:wrap;gap:4px 20px;align-items:baseline;margin:0 0 14px;padding:10px 16px; }
.basic-cell h3 { margin:0 8px 0 0; }
...
<main class="right-column">
  ...
  <article class="case">
    <h2>剖検で心筋炎、報告医「関連あり、他要因の可能性無し」――専門家も「心筋炎で矛盾しない」としつつ、理由を示さずγ</h2>
  ...
  <article class="case">
    <h2>剖検で微小梗塞、「血栓症による心室細動」、報告医「関連あり、他要因の可能性無し」――DICを除く鑑別診断に必要な情報が不足としてγ</h2>
  ...
  <article class="case">
    <h2>下肢血栓が肺動脈に詰まり急死、報告医「関連あり、他要因の可能性無し」――3か月後で臨床経過・接種前の血栓リスクが不明としてγ</h2>
  ...
  <article class="case"><h2>解剖で右冠動脈に新しい血栓、報告医「関連あり、他要因の可能性無し」――心筋梗塞のリスク因子が複数あるとしてγ</h2><p class="case-meta">80歳女性・症例 No.185</p>
  ...
  <article class="case"><h2>薬剤性肺障害の可能性、報告医「関連あり、他要因の可能性無し」――詳細な臨床データと病理所見が必要としてγ</h2><p class="case-meta">80歳男性・症例 No.862</p>
  ...
  <article class="case"><h2>解剖で急性心筋炎・多量の心嚢水、報告医「関連あり、他要因の可能性無し」――白血病治療中で感染症も疑われ、情報不十分としてγ</h2><p class="case-meta">43歳男性・症例 No.1260</p>
  ...
  <article class="case"><h2>剖検で急性心筋炎、報告医「関連あり、他要因の可能性無し」――剖検の具体的所見と心機能低下等の客観的所見が不足としてγ</h2><p class="case-meta">36歳男性・症例 No.1332</p>
  ...
  <article class="case"><h2>病理解剖で全身の血栓、肺動脈血栓性塞栓、報告医「関連あり、他要因の可能性無し」――凝固系データがなく、他の増悪因子も否定できないとしてγ</h2><p class="case-meta">64歳女性・症例 No.1737</p>
  ...
  <div class="compact-cases alpha">
    <article class="case">
      ...
      <a class="evidence-link" href="src/vaxxcausal/pages/001161432-p290.png" data-full="src/vaxxcausal/pages/001161432-p290.png" data-box="2.5,14,95,31" data-page-label="元PDF 290ページと切抜き範囲"><img class="source-image" src="src/vaxxcausal/alpha-14.png?v=2" alt="14歳女性のα評価症例を掲載した厚生労働省資料"></a>
    ...
    <article class="case">
      ...
      <a class="evidence-link" href="src/vaxxcausal/pages/001197724-p40.png" data-full="src/vaxxcausal/pages/001197724-p40.png" data-box="4,10,92,42" data-page-label="元PDF 40ページと切抜き範囲"><img class="source-image" src="src/vaxxcausal/alpha-42.png?v=2" alt="42歳女性のα評価症例を掲載した厚生労働省資料"></a>
...
(() => {
  ...
  const cropBoxes = {
    ...
    'no185-medical.png': '495,944,831,83;1792,938,274,96',
    'no185-eval.png': '495,944,831,83;1792,938,274,96',
    'no862-medical.png': '495,966,831,32;1792,940,273,84',
    'no862-eval.png': '495,966,831,32;1792,940,273,84',
    'no1260-medical.png': '495,300,831,148;1792,309,272,134',
    'no1260-eval.png': '495,300,831,148;1792,309,272,134',
    'no1332-medical.png': '495,889,831,96;1792,864,275,147',
    'no1332-eval.png': '495,889,831,96;1792,864,275,147',
    'no1737-medical.png': '495,288,831,273;1792,351,275,147',
    'no1737-eval.png': '495,288,831,273;1792,351,275,147',
    'no1762-medical.png': '495,539,831,83;1792,545,274,71',
    'no1762-eval.png': '495,539,831,83;1792,545,274,71',
    'no1790-row.png': '495,735,831,247;1792,791,274,134',
    'no1790-eval.png': '495,735,831,247;1792,791,274,134',
    'no1808-eval.png': '1425,1212,270,196',
    'no101-medical.png': '494,774,832,121',
