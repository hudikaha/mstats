...
(() => {
  ...
  const cropBoxes = {
    ...
    'no1260-medical.png': '495,360,831,32;1792,309,272,134',
    'no1260-eval.png': '495,360,831,32;1792,309,272,134',
    'no1332-medical.png': '495,927,831,20;1792,864,275,147',
    'no1332-eval.png': '495,927,831,20;1792,864,275,147',
...
puts rendered_html.gsub(%r{(src/vaxcausal/(?:no|alpha)[^"?]+\.png)(?:\?v=\d+)?}, '\1?v=6')
