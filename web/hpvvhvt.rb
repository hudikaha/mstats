...
lag = if cgi['lag'].empty?
        ...
        [[(cgi['lag'].to_f * 2).round / 2.0, -12].max, 12].min
      end
...
<section id="sourceSection">
  ...
  <div id="sourcePages">
    ...
    <img class="source-page" src="hpvvhvt-src/page-3.jpg" alt="">
    <img class="source-page" src="hpvvhvt-src/page-4.jpg" alt="">
    <img class="source-page" src="hpvvhvt-src/page-5.jpg" alt="">
